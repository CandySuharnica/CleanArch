...
import by.candy.suharnica.android.composeUI.*
import dev.rodkin.syharnicacleanarch.composeUI.screens.BasketScreen
import dev.rodkin.syharnicacleanarch.composeUI.screens.Profile
...
fun NavigationGraph() {
    ...
    NavHost(navController, startDestination = NavGraph.Catalog.route) {
        ...
        composable(NavGraph.Basket.route) {
            ...
            BasketScreen(viewModel = basketViewModel, navController = navController)
        }
        ...
        composable(
            ...
            DetailScreen(viewModel = detailCatalogViewModel, navController = navController, backStackEntry.arguments?.getLong("itemId") ?: 0)
        }
    }
}
